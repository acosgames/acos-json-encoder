 ...
 */
export function setStringDictionaryWT(dict) {
...
export function encodeNode(value, node, buffer) {
    switch (node.kind) {
...
// ─── Decoder ──────────────────────────────────────────────────────────────────
export function decodeNode(ref, node) {
    switch (node.kind) {
...
export function registerProtocolWT(protocolOrTypeName, payloadSchema) {
    let typeName;
    let schema;
 ...
 */
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export function protoEncodeWT(data) {
 ...
 */
export function protoDecodeWT(data) {
    let view;
